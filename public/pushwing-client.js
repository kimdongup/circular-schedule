...
(function (global) {
  ...
  function urlBase64ToUint8Array(base64String) {
    ...
    constructor(options = {}) {
      ...
      this.swPath = options.swPath || (typeof window !== 'undefined' && window.location.pathname.startsWith('/client') ? '/client/sw.js' : '/sw.js');
      this.scope = options.scope || (typeof window !== 'undefined' && window.location.pathname.startsWith('/client') ? '/client/' : '/');
